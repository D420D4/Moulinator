...
compile()
{
	cc -g -Wall -Wextra -Werror -D BUFFER_SIZE=$5 -D FOLDER=\"$2\" -I $1 $1/get_next_line.c $1/get_next_line_utils.c $3 -o $4
}

test_compile_2()
{
	res=`cc -g -Wall -Wextra -Werror -D BUFFER_SIZE=1 -D FOLDER=\"$2\" -I $1 $1/get_next_line.c $1/get_next_line_utils.c $2 -o /dev/null 2>&1` 
	if [[ $res != "" ]]; then
		echo 0
...
for i in {1..4}; do
	compile $folder_source $folder_test $folder_test./test$i.c $folder_test./test$i.bin 42 
